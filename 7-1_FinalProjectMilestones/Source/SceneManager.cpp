...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture(
		"../../Utilities/textures/fur_carpet.jpg",
		"fur_carpet");
	...
	bReturn = CreateGLTexture(
		"../../Utilities/textures/flat.jpg",
		"flat");

	bReturn = CreateGLTexture(
		"../../Utilities/textures/chalkboard.jpg",
		"chalkboard");
...
void SceneManager::DefineObjectMaterials(){
	...
	paperMaterial.ambientColor = glm::vec3(0.1f, 0.1f, 0.1f);
	paperMaterial.ambientStrength = 0.2f;
	paperMaterial.diffuseColor = glm::vec3(0.2f, 0.2f, 0.2f);
	paperMaterial.specularColor = glm::vec3(0.6f, 0.6f, 0.6f);
	paperMaterial.shininess = 70.0;
	paperMaterial.tag = "paper";
	m_objectMaterials.push_back(paperMaterial);

	OBJECT_MATERIAL plushMaterial;
	plushMaterial.ambientColor = glm::vec3(0.3f, 0.3f, 0.3f);
	plushMaterial.ambientStrength = 0.2f;
	plushMaterial.diffuseColor = glm::vec3(0.2f, 0.2f, 0.2f);
	plushMaterial.specularColor = glm::vec3(0.6f, 0.6f, 0.6f);
	plushMaterial.shininess = 0.0;
	plushMaterial.tag = "plush";
	m_objectMaterials.push_back(plushMaterial);
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[0].position", 0.0f, 6.0f, 20.0f);
	...
	m_pShaderManager->setVec3Value("lightSources[1].position", 19.0f, 4.0f, 5.0f);
	m_pShaderManager->setVec3Value("lightSources[1].ambientColor", 0.01f, 0.01f, 0.2f);
...
void SceneManager::RenderScene()
{
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-10.0f, 2.0f, -0.5f);
	...
	SetShaderTexture("fur_carpet");
	SetTextureUVScale(0.2, 0.2);
	SetShaderMaterial("plush");
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-11.0f, 1.5f, 5.25f);
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(4.0f, 1.0f, 6.0f);
	...
	SetShaderTexture("chalkboard");
	SetTextureUVScale(0, 0);
...
//Created new function to house each shape and it's transformations for the marker.
//Code borrowed from RenderScene.
void SceneManager::RenderMarker() {
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(3.0f, 0.5f, 2.25f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(1.69f, 0.57f, 3.51f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(2.95f, 0.5f, 2.3f);
	...
	YrotationDegrees = -39.0f;
	ZrotationDegrees = 15.0f;

	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.65f, 0.6f, 4.5f);
